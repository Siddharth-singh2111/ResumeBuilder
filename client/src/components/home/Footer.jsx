...
const Footer = () => {
  return (
    <>
         <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 mt-40 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-black bg-gradient-to-r from-white via-green-600/60 to-white ">
                <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
                    <a href="#">
                        <img src='/logo.svg' alt='logo' className='h-11 w-auto'></img>
                    </a>
                    <div>
                    ...
                    <div>
                        <p className="text-black font-semibold">Legal</p>
                        <ul className="mt-2 space-y-2">
                ...
                <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
                    ...
                    <div className="flex items-center gap-4 mt-3">
                        ...
                        <a href="https://www.linkedin.com/in/siddharth-singh-dev/" target="_blank" rel="noreferrer">
                    ...
                    <p className="mt-3 text-center">© 2025 <a href="https://prebuiltui.com">ResumeBuilder</a></p>
                </div>
            </footer>
