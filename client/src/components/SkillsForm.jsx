  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='flex gap-2'>
            <input type='text' placeholder='Enter a Skill(eg. Javascript,React,Nodejs etc)' className='flex-1 px-3 py-2 text-sm'
        ...
        <div className='bg-blue-50 p-3 rounded-lg mx-1'>
            <p className='text-sm text-blue-800 '><strong className='gap-4'>Tip:</strong>Add 8-12 relevent skills . Include both technical and soft skills .</p>
        </div>
